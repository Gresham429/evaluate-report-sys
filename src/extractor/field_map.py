...
SURVEY_FIELDS: dict[str, str] = {
    ...
    "report_no": "H2",
    # H3/H4 的语义以 F 列标签为准（实测三份 Excel 一致）：
    #   F3=「估价报告出具日期」→ H3 存日期序列号（如 46139 = 2026-04-27）
    #   F4=「估价作业期」      → H4 存区间文本（如「2026年4月20日至2026年4月27日」）
    # 早期版本据旧素材写反了这两项，会让报告印出「估价作业期：46139」这样的裸序列号。
    "issue_date": "H3",
    "work_period": "H4",
}
